...
const Products = () => {
    ...
    <div className="container gap-4 flex my-20  ">

    <div className=" basis-5/6 mt-2 h-full  rounded-md p-2 "> 
        <Search />
       </div>
    
    <div className='  grid grid-cols-4 gap-4  basis-6/7 h-72 scroll overflow-y-scroll '>
